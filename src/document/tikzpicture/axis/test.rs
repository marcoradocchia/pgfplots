...
// #[test]
// fn axis_keys_tested() {
//     let axis_key = AxisOption::Custom(String::from(""));
//     match axis_key {
//         AxisOption::Custom(_) => (),
//         AxisOption::XMode(_) => (),
//         AxisOption::YMode(_) => (),
...
//     assert_eq!(
//         AxisOption::YLabel(String::from("Random Label")).to_string(),
//         "ylabel={Random Label}"
//     );
// }
//
...
//     assert_eq!(
//         AxisOption::XLabel(String::from("Random Label")).to_string(),
//         "xlabel={Random Label}"
//     );
// }
//
...
//     assert_eq!(
//         AxisOption::Title(String::from("Random Title")).to_string(),
//         "title={Random Title}"
//     );
// }
//
...
//     assert_eq!(
//         AxisOption::Custom(String::from("something/random here")).to_string(),
...
//     assert_eq!(
//         AxisOption::XMode(Scale::Log).to_string(),
//         String::from("xmode=log")
//     );
//     assert_eq!(
//         AxisOption::XMode(Scale::Normal).to_string(),
...
//     assert_eq!(
//         AxisOption::YMode(Scale::Log).to_string(),
//         String::from("ymode=log")
//     );
//     assert_eq!(
//         AxisOption::YMode(Scale::Normal).to_string(),
...
//     assert!(matches!(axis.keys[0], AxisOption::Title(_)));
// }
//
// #[test]
// fn axis_set_x_label() {
...
//     assert_eq!(axis.keys.len(), 1);
//     assert!(matches!(axis.keys[0], AxisOption::XLabel(_)));
// }
//
// #[test]
// fn axis_set_y_label() {
...
//     assert_eq!(axis.keys.len(), 1);
//     assert!(matches!(axis.keys[0], AxisOption::YLabel(_)));
// }
//
// #[test]
// fn axis_add_key() {
//     let mut axis = Axis::new();
//     axis.add_key(AxisOption::YMode(Scale::Log));
//     assert_eq!(axis.keys.len(), 1);
...
//     assert_eq!(axis.keys[0].to_string(), String::from("ymode=log"));
//
//     axis.add_key(AxisOption::XMode(Scale::Log));
//     assert_eq!(axis.keys.len(), 2);
//     assert_eq!(axis.keys[0].to_string(), String::from("ymode=log"));
//     assert_eq!(axis.keys[1].to_string(), String::from("xmode=log"));
//
//     axis.add_key(AxisOption::Custom(String::from("random")));
